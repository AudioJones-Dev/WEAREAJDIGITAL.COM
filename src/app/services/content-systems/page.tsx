      ...
      <main className="max-w-4xl mx-auto py-16 px-4 md:px-8 bg-bg-0 text-fg-1">
        <header className="mb-16 text-center border-b border-border-subtle pb-12">
          ...
          <div className="flex flex-col items-center justify-center space-y-3">
            ...
            <p className="t-small text-fg-2">Built for serious operators | Systemized, not improvised | Strategy plus execution</p>
          </div>
        </header>
        ...
        <article className="prose prose-invert max-w-none">
          ...
          <div className="overflow-x-auto my-8">
            <table className="min-w-full border-collapse border border-border-subtle rounded-lg">
              <caption className="t-label text-left mb-4">The Repurposing Output Matrix</caption>
              <thead className="bg-bg-3 border-b-2 border-signal-yellow">
                <tr>
                  <th className="border-x border-border-subtle px-4 py-3 text-left">Content Input</th>
                  <th className="border-x border-border-subtle px-4 py-3 text-left">Repurposed Assets</th>
                  <th className="border-x border-border-subtle px-4 py-3 text-left">Business Outcome</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td className="border-x border-b border-border-subtle px-4 py-3 font-medium text-fg-1">Podcast episode</td>
                  <td className="border-x border-b border-border-subtle px-4 py-3 text-fg-2">Clips, a blog post, social captions, email copy</td>
                  <td className="border-x border-b border-border-subtle px-4 py-3 text-fg-0 font-medium">Authority, consistency, and reach</td>
                </tr>
                <tr className="bg-bg-2/40">
                  <td className="border-x border-b border-border-subtle px-4 py-3 font-medium text-fg-1">Webinar</td>
                  <td className="border-x border-b border-border-subtle px-4 py-3 text-fg-2">Lead magnets, summary articles, follow-up emails</td>
                  <td className="border-x border-b border-border-subtle px-4 py-3 text-fg-0 font-medium">Education and conversion</td>
                </tr>
                <tr>
                  <td className="border-x border-b border-border-subtle px-4 py-3 font-medium text-fg-1">Founder interview</td>
                  <td className="border-x border-b border-border-subtle px-4 py-3 text-fg-2">Short clips, quote posts, newsletters</td>
                  <td className="border-x border-b border-border-subtle px-4 py-3 text-fg-0 font-medium">Positioning and thought leadership</td>
                </tr>
                <tr className="bg-bg-2/40">
                  <td className="border-x border-b border-border-subtle px-4 py-3 font-medium text-fg-1">Customer conversation</td>
                  <td className="border-x border-b border-border-subtle px-4 py-3 text-fg-2">Case study assets, testimonials, proof content</td>
                  <td className="border-x border-b border-border-subtle px-4 py-3 text-fg-0 font-medium">Sales enablement</td>
                </tr>
                <tr>
                  <td className="border-x border-b border-border-subtle px-4 py-3 font-medium text-fg-1">Internal training video</td>
                  <td className="border-x border-b border-border-subtle px-4 py-3 text-fg-2">SOPs, onboarding material, internal docs</td>
                  <td className="border-x border-b border-border-subtle px-4 py-3 text-fg-0 font-medium">Operational consistency</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div className="aj-card is-surface-2 p-8 my-8">
            <h3 className="t-h4 text-signal-yellow mb-6 mt-0">The AJ Digital Content Systems Framework</h3>
            <ol className="text-fg-1 space-y-4 m-0">
              <li><strong className="text-fg-0">Capture long-form content</strong>: Record dense, high-signal source material.</li>
              <li><strong className="text-fg-0">Extract key ideas and moments</strong>: Surface the strongest frameworks, stories, and hooks.</li>
              <li><strong className="text-fg-0">Transform into platform-specific assets</strong>: Convert the source into assets for search, social, and email.</li>
              <li><strong className="text-fg-0">Distribute consistently</strong>: Publish through a repeatable workflow instead of ad hoc posting.</li>
              <li><strong className="text-fg-0">Optimize for SEO and AEO</strong>: Structure outputs so they are easier to rank and easier to extract.</li>
              <li><strong className="text-fg-0">Route attention into offers</strong>: Tie content back to proof, offers, and qualified next steps.</li>
            </ol>
          </div>
          ...
          <div className="overflow-x-auto my-8">
            <table className="min-w-full border-collapse border border-border-subtle rounded-lg">
              <thead className="bg-bg-3">
                <tr>
                  <th className="border-x border-border-subtle px-4 py-4 text-left text-accent-red font-bold w-1/2">Typical Content Agency</th>
                  <th className="border-x border-border-subtle px-4 py-4 text-left text-signal-yellow font-bold w-1/2">AJ Digital</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td className="border-x border-b border-border-subtle px-4 py-4 text-fg-2">One-off deliverables</td>
                  <td className="border-x border-b border-border-subtle px-4 py-4 font-bold text-fg-0 bg-signal-yellow/5">Repeatable content systems</td>
                </tr>
                <tr className="bg-bg-2/30">
                  <td className="border-x border-b border-border-subtle px-4 py-4 text-fg-2">Manual posting</td>
                  <td className="border-x border-b border-border-subtle px-4 py-4 font-bold text-fg-0 bg-signal-yellow/5">Scalable content infrastructure</td>
                </tr>
                <tr>
                  <td className="border-x border-b border-border-subtle px-4 py-4 text-fg-2">Disconnected workflows</td>
                  <td className="border-x border-b border-border-subtle px-4 py-4 font-bold text-fg-0 bg-signal-yellow/5">Automation-enabled systems</td>
                </tr>
                <tr className="bg-bg-2/30">
                  <td className="border-x border-b border-border-subtle px-4 py-4 text-fg-2">Vanity metrics</td>
                  <td className="border-x border-b border-border-subtle px-4 py-4 font-bold text-fg-0 bg-signal-yellow/5">Authority, traffic, and lead generation</td>
                </tr>
                <tr>
                  <td className="border-x border-b border-border-subtle px-4 py-4 text-fg-2">Isolated assets</td>
                  <td className="border-x border-b border-border-subtle px-4 py-4 font-bold text-fg-0 bg-signal-yellow/5">Integrated content engines</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div className="aj-callout my-10">
            <p className="m-0 font-medium text-signal-yellow mb-2">Explore the architecture blueprints:</p>
            <div className="flex flex-col space-y-2">
              <Link href="/blog/content-repurposing-guide" className="text-fg-1 hover:text-signal-yellow transition-colors underline underline-offset-4 text-sm font-medium">Pillar guide: content repurposing guide</Link>
              <Link href="/blog/content-repurposing-system" className="text-fg-1 hover:text-signal-yellow transition-colors underline underline-offset-4 text-sm font-medium">Cluster: content repurposing system basics</Link>
              <Link href="/blog/podcast-content-repurposing" className="text-fg-1 hover:text-signal-yellow transition-colors underline underline-offset-4 text-sm font-medium">Cluster: podcast content repurposing</Link>
              <Link href="/blog/ai-content-automation-guide" className="text-fg-1 hover:text-signal-yellow transition-colors underline underline-offset-4 text-sm font-medium">Pillar guide: AI content automation</Link>
          ...
          <div className="space-y-6 mt-6">
            <div>
              ...
              <p className="text-fg-1 m-0">A content system is a repeatable workflow that takes one strong source asset and turns it into multiple useful outputs across blog, social, email, and sales support channels.</p>
            </div>
            <div>
              <h3 className="text-xl font-bold mb-2">How many assets can one recording produce?</h3>
              <p className="text-fg-1 m-0">One strong recording can often produce 30 or more usable assets, depending on the structure, quality, and distribution plan behind it.</p>
            </div>
            <div>
              <h3 className="text-xl font-bold mb-2">Is content repurposing worth it?</h3>
              <p className="text-fg-1 m-0">Yes. Repurposing gives the business more output, more consistency, and better reach without forcing the team to create every asset from zero.</p>
            </div>
            <div>
              <h3 className="text-xl font-bold mb-2">Do you automate workflows?</h3>
              <p className="text-fg-1 m-0">Yes. We use automation where it reduces manual drag and keeps the content workflow moving more reliably.</p>
            </div>
            <div>
              <h3 className="text-xl font-bold mb-2">Can this work with my podcast or video content?</h3>
              <p className="text-fg-1 m-0">Absolutely. Podcasts, interviews, webinars, and founder recordings are all strong inputs when the content system is designed properly.</p>
            </div>
            <div>
              <h3 className="text-xl font-bold mb-2">How long does it take to set up a system?</h3>
              <p className="text-fg-1 m-0">A foundational system can usually be designed and launched within a few weeks, depending on the workflow and how quickly source content is available.</p>
            </div>
          </div>
          ...
          <div className="mt-16 p-10 aj-card is-surface-2 text-center relative overflow-hidden">
            ...
            <p className="t-body-lg text-fg-2 mb-8 max-w-2xl mx-auto">Stop relying on random posting. Build a repeatable engine that compounds.</p>
