...
export default function PodcastAuthoritySystemCaseStudy() {
  ...
  return (
    <article className="min-h-screen bg-bg-base text-fg-0">
      <script
      ...
      {/* Hero Section */}
      <header className="py-20 px-6 sm:px-12 lg:px-24 bg-bg-base border-b border-border-subtle">
        <div className="max-w-4xl mx-auto">
          <p className="t-label text-signal-yellow mb-4">Case Study</p>
          <h1 className="t-h1 mb-8 text-fg-0">
          ...
          <div className="aj-card is-surface-2 p-8">
            <h2 className="t-h4 mb-6 flex items-center text-fg-0">
              <span className="w-2 h-2 bg-signal-yellow rounded-full mr-3"></span>
              At a Glance
            </h2>
            <ul className="t-body space-y-4 text-fg-2">
              <li><strong className="text-fg-0">Client Type:</strong> Entrepreneur / Brand / Organization</li>
              <li><strong className="text-fg-0">Problem:</strong> No system, inconsistent content output, and significant time bottlenecks.</li>
              <li><strong className="text-fg-0">Solution:</strong> End-to-end Podcast Production + Content Repurposing System + AI Workflows.</li>
              <li><strong className="text-fg-0">Result:</strong> 30+ strategic content assets per episode and newly generated inbound leads.</li>
            </ul>
          </div>
        </div>
      </header>
      ...
      <main className="py-16 px-6 sm:px-12 lg:px-24">
        <div className="max-w-3xl mx-auto prose prose-invert prose-lg prose-a:text-fg-0 hover:prose-a:text-signal-yellow">

          {/* Section 2: The Problem */}
          <h2 className="t-h2 mt-12 mb-6 text-fg-0">The Problem: Content Without a System</h2>
          <p>
          ...
          <h2 className="t-h2 mt-16 mb-6 text-fg-0">The System Implemented</h2>
          <p>
            We stopped the random acts of marketing and deployed a unified, centralized strategy using our core service architectures.
          </p>

          <h3 className="t-h3 mt-8 mb-4 text-fg-0">1. The Podcast System</h3>
          <p>
          ...
          <h3 className="t-h3 mt-8 mb-4 text-fg-0">2. The Content System</h3>
          <p>
          ...
          <h3 className="t-h3 mt-8 mb-4 text-fg-0">3. AI Integration</h3>
          <p>
          ...
          {/* Section 4: Execution */}
          <h2 className="t-h2 mt-16 mb-6 text-fg-0">Execution: A Step-by-Step Build</h2>
          <p>
          ...
          {/* Section 5: Results */}
          <div className="aj-callout my-16 p-8">
            <h2 className="t-h2 mt-0 mb-6 text-fg-0">The Results</h2>
            <p className="t-body font-medium mb-6 text-fg-1">
            ...
            <div className="grid gap-4 md:grid-cols-4 not-prose mb-8">
              {[
                ...
                <div key={label} className="aj-card is-surface-2 p-5 text-center">
                  <p className="t-mono text-3xl font-medium text-signal-yellow">{value}</p>
                  <p className="t-small mt-2 leading-6 text-fg-2">{label}</p>
                </div>
              ))}
            </div>
            <ul className="text-fg-0 space-y-3 font-semibold marker:text-signal-yellow">
          ...
          <h2 className="t-h2 mt-16 mb-6 text-fg-0">Key Takeaways</h2>
          <p>
      ...
      {/* Section 7: CTA */}
      <section className="py-24 px-6 relative overflow-hidden bg-surface-1 border-t border-border-subtle">
        <div className="max-w-3xl mx-auto text-center relative z-10">
          <h2 className="t-h2 mb-6 text-fg-0">Want to build a system like this?</h2>
          <p className="t-lead text-fg-2 mb-10 leading-relaxed max-w-2xl mx-auto">
